...
{
    [DbContext(typeof(MyCaDbContext))]
    partial class MyCaDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Menu.Menu", b =>
                {
                    b.OwnsOne("Domain.Commons.ValueObjects.Rating.AverageRating", "AverageRating", b1 =>
                        {
                    ...
                    b.OwnsMany("Domain.Menu.Entities.MenuSection", "Sections", b1 =>
                        {
                            ...
                            b1.OwnsMany("Domain.Menu.MenuItem", "Items", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier")
